...
class DSession:
    ...
    def __init__(self, loop: asyncio.AbstractEventLoop, connector: Optional[aiohttp.TCPConnector] = None) -> None:
    ...
    def send_message(
        ...
        *,
        ...
        :param nonce: A value for verifying whether the message was sent successfully, defaults to None
        ...
        :param message_reference: Reference to the message to which the response is being sent, if any, defaults to None
        ...
        :param payload_json: JSON-encoded body of non-file params when uploading files, defaults to None
        :type payload_json: Optional[str], optional
        :param attachments: Attachment objects with filename and description, defaults to None
        :type attachments: Optional[Sequence[DAttachment]], optional
        :param flags: Message flags combined as a bitfield (SUPPRESS_EMBEDS and SUPPRESS_NOTIFICATIONS), defaults to None
